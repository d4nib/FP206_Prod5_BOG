...
public class CustomerController implements Initializable {
    ...
    public void addCustomer(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/bog_views/CustomerDialogView.fxml"));
    ...
    public void closeWindows() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/bog_views/MainView.fxml"));
            Parent root = loader.load();
